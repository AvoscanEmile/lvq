...
#### 1. Atomic `fstab` Transaction Logic and Core Expansion
...
#### 2. Comprehensive Swap Lifecycle and Path Logic
...
#### 3. State-Aware Verification and Pre-flight Guardrails
...
#### 4. Warning Propagation and Daemon Synchronization
